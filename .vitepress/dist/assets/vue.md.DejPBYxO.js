import{_ as s,c as n,o as a,a2 as p}from"./chunks/framework.mHHrDb8M.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"vue.md","filePath":"vue.md"}'),e={name:"vue.md"},l=p(`<p>vue生命周期</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1.生命周期就是vue实例从创建到销毁的整个过程</span></span>
